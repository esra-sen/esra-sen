...
<head>
    ...
    <title>Esra Nur Şen - Profil</title>
...
<body>
    ...
    <div class="wrap">
        <div class="hero">
            ...
            <h1>Esra Nur Şen</h1>
            <p class="hero-sub">Software Engineering Student &nbsp;·&nbsp; <span class="backend-developer">Backend Developer</span></p>
        ...
        <div class="section">
            ...
            <p class="stack-category">LANGUAGES</p>
            ...
            <p class="stack-category">FRAMEWORKS & TOOLS</p>
        ...
        <div class="section">
            ...
            <div class="project-card">
                ...
                <p class="muted-text">Check out the latest project on GitHub for source code, docs, and demos.</p>
                <div class="project-tags">
                    <a href="https://github.com/esra-sen" target="_blank" class="github-view-link"><span class="ptag">→ view on github</span></a>
                </div>
            </div>
        </div>

        <div class="footer">
            <p>built with <span class="purple-heart">💜</span> • <a href="mailto:esranurssen@gmail.com">esranurssen@gmail.com</a></p>
            <p class="copyright">© 2026 Esra Nur Şen</p>
        </div>
    </div>
</body>
</html>
